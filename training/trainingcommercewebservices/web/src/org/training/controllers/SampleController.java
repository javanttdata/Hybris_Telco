...
import static org.training.constants.TrainingcommercewebservicesConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static org.training.constants.TrainingcommercewebservicesConstants.PASSWORD_AUTHORIZATION_NAME;
import static org.training.constants.TrainingcommercewebservicesConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static org.training.constants.TrainingcommercewebservicesConstants.SAMPLE_LIST_STRING_VALUE;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/trainingcommercewebservices/sample/dto/sampleValue
	 *
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/trainingcommercewebservices/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users?fields=users(info)
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/usersPaged
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1?fields=info
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/trainingcommercewebservices/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 * <p>
	 * Url: http://localhost:9001/trainingcommercewebservices/sample/map
	 */
